...
CREATE TABLE xz_user1(
  id INT PRIMARY KEY AUTO_INCREMENT,
  uname VARCHAR(25),
  upwd  VARCHAR(32)
);
#通用加密算法md5
INSERT INTO xz_user1 VALUES(null,'dd',md5('123'));
INSERT INTO xz_user1 VALUES(null,'wh',md5('123'));
INSERT INTO xz_user1 VALUES(null,'lily',md5('123'));
